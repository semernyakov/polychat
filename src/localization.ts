...
export const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    inputHint: '<kbd>Ctrl</kbd>+<kbd>Enter</kbd> — отправить, <kbd>Shift</kbd>+<kbd>Enter</kbd> — новая строка',
    inputCounterTitle: 'Текущее кол-во символов / Макс. кол-во токенов для модели (приблизительное сравнение)',
  ...
  en: {
    ...
    inputHint: '<kbd>Ctrl</kbd>+<kbd>Enter</kbd> — send, <kbd>Shift</kbd>+<kbd>Enter</kbd> — new line',
