...
export const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'thanks.reviewBefore': 'Если вам нравится Groq Chat, пожалуйста, ',
    'thanks.reviewLink': 'оставьте отзыв на GitHub',
    'thanks.reviewAfter': '.',
    'thanks.telegramLink': 'связаться со мной в Telegram',
    'thanks.telegramBefore': ' или ',
    'thanks.telegramAfter': ' ❤️',
    'thanks.yoomoneyLink': 'поддержать разработку на YooMoney',
    'thanks.yoomoneyBefore': ' Вы можете ',
    'thanks.yoomoneyAfter': '.',
    apiKey: 'API ключ',
  ...
  en: {
    ...
    'thanks.reviewBefore': 'If you like Groq Chat, please ',
    'thanks.reviewLink': 'leave a review on GitHub',
    'thanks.reviewAfter': '.',
    'thanks.telegramLink': 'contact with author in Telegram',
    'thanks.telegramBefore': ' or ',
    'thanks.telegramAfter': ' ❤️',
    'thanks.yoomoneyLink': 'support the author on YooMoney',
    'thanks.yoomoneyBefore': ' You can ',
    'thanks.yoomoneyAfter': '.',
    apiKey: 'API Key',
