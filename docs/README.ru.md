...
- 🤖 Поддержка моделей Groq:
  - **Llama 3 70B** — для сложных задач
  - **Mixtral 8x7B** — для быстрых ответов
  - **Gemma 2 9B** — для эффективной работы
  - **Whisper Large V3** — для транскрипции аудио
